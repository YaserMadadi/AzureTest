...
import { ProviderEditUI } from '../edit/provider.edit'
import { ProviderDeleteUI } from '../delete/provider.delete'
...
import { EnterpriseProviderEditUI } from '../../enterpriseProvider/edit/enterpriseProvider.edit';
...
@Component({
  selector: 'base-provider-index',
  templateUrl: './provider.hub.html',
  styleUrls: ['./provider.hub.scss'],
...
export class ProviderHubUI extends HubUI<Provider> implements IHubUI<Provider> {
